...
var Projects = function (_a) {
    ...
    var _c = useState(false), projectsLoaded = _c[0], setProjectsLoaded = _c[1];
    var fetchProjects = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios.get('/api/projects')];
                case 1:
                    response = _a.sent();
                    json = response.data;
                    // let json = await response.json();
                    return [2 /*return*/, { success: true, data: json }];
                case 2:
                    error_1 = _a.sent();
                    console.log(error_1);
    ...
    return (_jsxs("div", __assign({ className: 'projects' }, { children: [_jsx("h2", { children: "Projects" }), _jsx("ul", { children: projects
                    .filter(function (prj) { return prj.parent === null; })
